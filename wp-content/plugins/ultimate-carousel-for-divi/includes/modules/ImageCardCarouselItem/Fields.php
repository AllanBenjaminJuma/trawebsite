...
class Fields
{
    ...
    public function get_fields()
    {
        ...
        $fields['open_url'] = [
            'label'       => esc_html__( 'Open URL On Item Click?', 'et_builder' ),
            'type'        => 'yes_no_button',
            'options'     => [
            ...
            'tab_slug'    => 'general',
            'toggle_slug' => 'button',
            'description' => esc_html__( 'Open an URL when the image card is clicked.', 'et_builder' ),
        ...
        $fields['card_url'] = [
            ...
            'description' => esc_html__( 'Enter the URL to which the card should point to.', 'et_builder' ),
