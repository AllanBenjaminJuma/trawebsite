...
class Fields
{
    ...
    public function get_woo_product_fields()
    {
        $fields = [];
        $fields['criteria'] = [
            'label'       => esc_html__( 'Listing Criteria', 'et_builder' ),
            'type'        => 'select',
            'options'     => [
            ...
            'description' => esc_html__( 'Select the criteria/filter for the product list.', 'et_builder' ),
            'show_if'     => [],
            'default'     => $this->get_default( 'criteria' ),
        ];
        $fields['categories'] = [
            'label'         => esc_html__( 'Product Categories', 'et_builder' ),
            'type'          => 'categories',
            'taxonomy_name' => 'product_cat',
            'post_type'     => 'product',
            'tab_slug'      => 'general',
            'toggle_slug'   => 'wc_products',
            'description'   => esc_html__( 'Select one or more categories.', 'et_builder' ),
            'show_if'       => [
        ...
        $fields['tags'] = [
            'label'         => esc_html__( 'Product Tags', 'et_builder' ),
            'type'          => 'categories',
            'taxonomy_name' => 'product_tag',
            'post_type'     => 'product',
            'tab_slug'      => 'general',
            'toggle_slug'   => 'wc_products',
            'description'   => esc_html__( 'Select one or more product tags.', 'et_builder' ),
            'show_if'       => [
            'criteria' => 'custom_filter',
        ],
        ...
        $fields['orderby'] = [
            ...
            'tab_slug'    => 'general',
            'toggle_slug' => 'wc_products',
            'description' => esc_html__( 'Select ordering criteria', 'et_builder' ),
            'show_if'     => [
            'criteria' => 'custom_filter',
        ],
        ...
        $fields['order'] = [
            'label'       => esc_html__( 'Order Direction', 'et_builder' ),
            'type'        => 'select',
            'options'     => [
            'ASC'  => 'Ascending',
            'DESC' => 'Descending',
            ...
            'tab_slug'    => 'general',
            'toggle_slug' => 'wc_products',
            'description' => esc_html__( 'Select either ascending or descending order.', 'et_builder' ),
            'show_if'     => [
            'criteria' => 'custom_filter',
        ],
        ...
        $fields['post__in'] = [
            'label'       => esc_html__( 'Include Products By ID', 'et_builder' ),
            'type'        => 'text',
            'tab_slug'    => 'general',
            'toggle_slug' => 'wc_products',
            'description' => esc_html__( 'Enter comma-separated product IDs to include', 'et_builder' ),
            'show_if'     => [
            'criteria' => 'custom_filter',
        ],
        ...
        $fields['post__not_in'] = [
            'label'       => esc_html__( 'Exclude Products By ID', 'et_builder' ),
            'type'        => 'text',
            'tab_slug'    => 'general',
            'toggle_slug' => 'wc_products',
            'description' => esc_html__( 'Enter comma-separated product IDs to exclude', 'et_builder' ),
            'show_if'     => [
            'criteria' => 'custom_filter',
        ],
        ...
        $fields['posts_per_page'] = [
            'label'          => esc_html__( 'Total Products In Carousel', 'et_builder' ),
            'type'           => 'range',
            'range_settings' => [
            'min'  => -1,
            'max'  => 300,
            ...
            'tab_slug'       => 'general',
            'toggle_slug'    => 'wc_products',
            'description'    => esc_html__( 'Set to "-1" to show all the products. Or any positive integer to show fixed number of products.', 'et_builder' ),
            'validate_unit'  => false,
            'allowed_units'  => [ '' ],
            'default_unit'   => '',
