...
class Swiper
{
    ...
    public function set_settings_modal_toggles( &$toggles )
    {
        ...
        $toggles['general']['toggles']['carousel'] = [
            'title'    => esc_html__( 'Carousel', 'et_builder' ),
            'priority' => 3,
        ];
        // advanced
    ...
    public function get_carousel_setting_fields()
    {
        ...
        $fields['space_between'] = [
            'label'          => esc_html__( 'Space Between Slides', 'et_builder' ),
            'type'           => 'range',
            'range_settings' => [
            'min'  => 0,
            'max'  => 100,
            ...
            'tab_slug'       => 'general',
            'toggle_slug'    => 'carousel',
            'description'    => esc_html__( 'Distance between slides (in pixels)', 'et_builder' ),
            'mobile_options' => false,
            'unitless'       => true,
            'default'        => $this->get_default( 'space_between' ),
        ];
        $fields['initial_slide'] = [
            'label'          => esc_html__( 'Initial Slide', 'et_builder' ),
            'type'           => 'range',
            'range_settings' => [
            'min'  => 0,
            'max'  => 500,
            ...
            'tab_slug'       => 'general',
            'toggle_slug'    => 'carousel',
            'description'    => esc_html__( 'Index number of initial slide.', 'et_builder' ),
            'show_if'        => [],
            'allowed_units'  => [ '' ],
            'default_unit'   => '',
            'validate_unit'  => false,
        ...
        $fields['centered_slides'] = [
            'label'       => esc_html__( 'Centered Slides', 'et_builder' ),
            'type'        => 'yes_no_button',
            'options'     => [
            ...
            'tab_slug'    => 'general',
            'toggle_slug' => 'carousel',
            'description' => esc_html__( 'If "Yes", then active slide will be centered, not always on the left side.', 'et_builder' ),
            'show_if'     => [],
