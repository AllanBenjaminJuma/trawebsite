...
<p style='display:block; margin-bottom: 1em; margin-top: -3px;'>Enter numeric number. This field and it's value can be used within the "Taxonomy Carousel" Divi Module for sorting.</p>