                                    ...
                                    if ($show_title == 'on') {
                                        ...
                                        $product_title = $multi_view->render_element(
                                            [
                                                ...
                                                'custom_props' => [
                                                    'title' => et_core_intentionally_unescaped($product->post_title, 'html'),
                                                ],
                                                'required'     => 'title',
                                            ]
                                        );
...
<?php else: ?>
	<div>
		...
		<p>Please check if you have product entries for the selected "Criteria".</p>
	</div>
<?php endif?>
